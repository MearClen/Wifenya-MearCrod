...
module.exports = async client => {
    ...
    client.user.setPresence({ activity: { name: "TESTING BOT", type: "WATCHING" }, status: "idle" });
    client.user.setPresence({ activity: { name: "hai aku baru", type: "WATCHING" }, status: "idle" });
